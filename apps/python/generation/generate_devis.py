...
OUTPUT_DIR = os.path.join(DATA_DIR, "devis", "valides")
...
def generate_devis(num):
    ...
    filename = f"{OUTPUT_DIR}/devis_{num:04d}.pdf"
    ...
    elements.append(Paragraph(f"N° {fake.numerify('DEVIS-####-##')}", bold))
...
print(f"\nDone ! {NB_DEVIS} devis dans {OUTPUT_DIR}/")
